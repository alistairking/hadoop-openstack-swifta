...
/**
 * Class that represents authentication to OpenStack Keystone. Contains basic authentication
 * information. Used when {@link ApiKeyAuthenticationRequest} is not applicable. (problem with
...
public class KeyStoneAuthRequest extends AuthenticationRequestV2 {
  ...
  public String toString() {
    return "KeyStoneAuthRequest as tenant '" + Objects.toString(tenantName) + "' "
        + Objects.toString(apiAccessKeyCredentials);
  }
}
