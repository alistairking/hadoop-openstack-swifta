 ...
 */
public class SwiftFileSystemBaseTest extends Assert implements SwiftTestConstants {

  protected static final Log LOG = LogFactory.getLog(SwiftFileSystemBaseTest.class);
  ...
  /**
   * Configuration generator. May be overridden to inject some custom options
   * 
  ...
  /**
   * Assume in a test that rename is supported; skip it if not.
   */
  ...
  /**
   * Assert that the result value == -1; which implies that a read was successful
   * 
